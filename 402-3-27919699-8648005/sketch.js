...
Officer: 8648005
CaseNum: 402-3-27919699-8648005
...
function draw()
{
	...
	///////////////////ADD YOUR CODE HERE///////////////////
	if (det.locationY < 319 && det.locationX < 87)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
    
    else if(det.locationX < 259 && det.locationY > 300) {
        
        det.speedX = 1;
        det.speedY = 0;
    }
    
    else if(det.locationX < 282 && det.locationY > 134) {
        
        det.speedX = 0;
        det.speedY = -1;
    }
   
    else if(det.locationX < 384 && det.locationY < 154) {
        
        det.speedX = 1;
        det.speedY = 0;
    }
    
    else if(det.locationX < 402 && det.locationY < 571) {
        
        det.speedX = 0;
        det.speedY = 1;
    }
    
    else if(det.locationX < 511 && det.locationY > 537) {
        
        det.speedX = 1;
        det.speedY = 0;
    }
    
    else if(det.locationX < 535 && det.locationY > 254)
    {
        det.speedX = 0;
        det.speedY = -1;
    }
    
    else if(det.locationX < 700 && det.locationY < 282)
    {
        det.speedX = 1;
        det.speedY = 0;
    }
    
    else if(det.locationX < 720 && det.locationY < 632)
        {
            det.speedX = 0;
            det.speedY = 1;
        }

    else if(det.locationX < 888 && det.locationY > 605)
        {
